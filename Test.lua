...
local Prediction = .175 -- Howl#4252 if you need help

local Y_Axis_Aim_Height = -1

local Smoothness = 15 -- Don't go lower.
...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "LowerTorso", "UpperTorso", "RightUpperArm", "RightLowerArm", "LeftUpperArm", "LeftLowerArm", "RightUpperLeg", "RightLowerLeg", "RightHand", "LeftHand", "RightFoot", "LeftFoot", "HumanoidRootPart",}
